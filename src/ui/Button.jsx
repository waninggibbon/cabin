export const Button = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`group relative box-border flex h-20 w-20 cursor-pointer items-center justify-center rounded-xl border-6 ${borderColor} bg-pine transition-all duration-500 hover:scale-[1.15] ${className || ''}`}
    >
      <div
